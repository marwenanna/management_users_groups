...
class User implements UserInterface
{
     ...
     * @Assert\Length(min=5, minMessage="Your password is equal to or greater than 6")
     */
    private $password;

    /**
     * @Assert\EqualTo(propertyPath="password", message="You do not have to enter the same password")
     */
